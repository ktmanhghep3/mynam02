...
function tbMiDao:OnDialog()
	Dialog:Say("Có muốn vào không?", 
			{
				--{"Có", self.Enter, self, him.dwId, me.nId},
				--{"Tạm thời chưa đi"},
			}
		);	
end;
...
tbQiHun.szText 	= "Bàn cờ biến hóa, ảo diệu vô cùng, thế gian vạn vật, bao quát trong đó, chúng ta hạ bàn kỳ.";
...
tbYingHun.szText 	= "Hay là trên thế giới chuyện khó khăn nhất, tựu có chiến thắng chính, ngươi chuẩn bị sẵn sàng?";
tbYingHun.tbCapyNpc	= {
		[1] = 4251,
		[2] = 4252,
...
function tbYingHun:OnDialog()
	Dialog:Say(self.szText, 
			{
				{"Bắt đầu giao đấu", self.FightStart, self, him.dwId, me.nId},
				{"Kết thúc đối thoại"},
			}
		);
end;
...
tbLiuYiBan_Dialog.szText = "<npc=4276>: sao lại có ngươi, sao chỗ nào cũng thấy ngươi? Ta không hiểu."
