...
function tbInstancing:OnNew()
		...
		self.tbNpcPos_BoSung	= {
			[1] = {9011, 150, 1,1585, 3177,5},-- VHC1_TMT
			[2] = {9011, 150, 1,1593, 3167,5},-- VHC1_TMT
			[3] = {9011, 150, 1,1591, 3189,5},-- VHC1_TMT
			[4] = {9011, 150, 1,1603, 3173,5},-- VHC1_TMT

			[5] = {9012, 150, 1,1674, 3130,5},-- VHC2_TPĐ
			[6] = {9012, 150, 1,1671, 3142,5},-- VHC2_TPĐ
			[7] = {9012, 150, 1,1682, 3151,5},-- VHC2_TPĐ
			[8] = {9012, 150, 1,1691, 3143,5},-- VHC2_TPĐ

			[9] = {9013, 150, 1,1721, 3067,5},-- VHC3_BV
			[10] = {9013, 150, 1,1708, 3070,5},-- VHC3_BV
			[11] = {9013, 150, 1,1713, 3056,5},-- VHC3_BV
			[12] = {9013, 150, 1,1714, 3088,5},-- VHC3_BV
			
			[13] = {9014, 150, 1,1723, 2975,5},-- VHC4_HNT
			[14] = {9014, 150, 1,1725, 2955,5},-- VHC4_HNT
			[15] = {9014, 150, 1,1740, 2957,5},-- VHC4_HNT
			[16] = {9014, 150, 1,1734, 2968,5},-- VHC4_HNT
			
			[17] = {9015, 150, 1,1688, 2916,5},-- VHC5_LS
			[18] = {9015, 150, 1,1675, 2893,5},-- VHC5_LS
			[19] = {9015, 150, 1,1690, 2884,5},-- VHC5_LS
			[20] = {9015, 150, 1,1698, 2903,5},-- VHC5_LS
			
			[21] = {9016, 150, 1,1672, 2909,5},-- VHC5_GN
			[22] = {9016, 150, 1,1697, 2912,5},-- VHC5_GN
			[23] = {9016, 150, 1,1684, 2891,5},-- VHC5_GN
			[24] = {9016, 150, 1,1678, 2899,5},-- VHC5_GN
			
			[25] = {9017, 150, 1,1664, 2957,5},-- VHC6_Báo
			[26] = {9017, 150, 1,1642, 2947,5},-- VHC6_Báo
			[27] = {9017, 150, 1,1628, 2932,5},-- VHC6_Báo
			[28] = {9017, 150, 1,1619, 2919,5},-- VHC6_Báo
			
			[29] = {9018, 150, 1,1593, 2877,5},-- VHC7_TiênTiên
			[30] = {9018, 150, 1,1603, 2885,5},-- VHC7_TiênTiên
			[31] = {9018, 150, 1,1588, 2898,5},-- VHC7_TiênTiên
			[32] = {9018, 150, 1,1586, 2883,5},-- VHC7_TiênTiên
			
			[33] = {9019, 150, 1,1613, 3031,5},-- VHC8_Tăng
			[34] = {9019, 150, 1,1605, 3053,5},-- VHC8_Tăng
			[35] = {9019, 150, 1,1600, 3036,5},-- VHC8_Tăng
			[36] = {9019, 150, 1,1620, 3047,5},-- VHC8_Tăng
	...
	self.pCaptain_Fight		= {
	self:AddNpc(self.tbNpcPos[4], self.nTreasureMapId);
	
	self:AddNpc(self.tbNpcPos_BoSung[1], self.nTreasureMapId);-- Thiết Mạc Tây Bổ Sung
	self:AddNpc(self.tbNpcPos_BoSung[2], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[3], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[4], self.nTreasureMapId);

	self:AddNpc(self.tbNpcPos_BoSung[5], self.nTreasureMapId);-- Thiết Phù Đồ Bổ Sung
	self:AddNpc(self.tbNpcPos_BoSung[6], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[7], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[8], self.nTreasureMapId);
	
	self:AddNpc(self.tbNpcPos_BoSung[25], self.nTreasureMapId);-- Báo Đốm Bổ Sung
	self:AddNpc(self.tbNpcPos_BoSung[26], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[27], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[28], self.nTreasureMapId);

	self:AddNpc(self.tbNpcPos_BoSung[17], self.nTreasureMapId);-- Liễu Sinh Bổ Sung
	self:AddNpc(self.tbNpcPos_BoSung[18], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[19], self.nTreasureMapId);
	self:AddNpc(self.tbNpcPos_BoSung[20], self.nTreasureMapId);
...
function tbInstancing:tbActions_1()
	...
	if pNpc then
		...
		self:AddNpc(self.tbNpcPos_BoSung[9], self.nTreasureMapId);-- Bách Vũ Bổ Sung
		self:AddNpc(self.tbNpcPos_BoSung[10], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[11], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[12], self.nTreasureMapId);

		self:AddNpc(self.tbNpcPos_BoSung[13], self.nTreasureMapId);-- Hoàng Tán Nhất Bổ Sung
		self:AddNpc(self.tbNpcPos_BoSung[14], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[15], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[16], self.nTreasureMapId);
...
function tbInstancing:tbActions_5()
	...
	if self.pTaoZi_Fight_2 then
		self.pTaoZi_Fight_2.SendChat("Tôi thấy có Cô Gái! Hãy đi xuống và cứu cô ấy!");
	...
	-- 出现 BOSS1 和青青
	local pQingQing_Fight_1	= {
		self:AddNpc(self.tbNpcPos[5], self.nTreasureMapId);
		
		self:AddNpc(self.tbNpcPos_BoSung[21], self.nTreasureMapId);-- Giả Như Bổ Sung
		self:AddNpc(self.tbNpcPos_BoSung[22], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[23], self.nTreasureMapId);
		self:AddNpc(self.tbNpcPos_BoSung[24], self.nTreasureMapId);
