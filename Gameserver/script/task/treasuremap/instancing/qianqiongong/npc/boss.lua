...
function tbBoss_6:OnDeath(pNpc)
	...
	if (pPlayer) then
		...
		pPlayer.AddStackItem(18,1,3083,1,nil,5);
		pPlayer.Earn(500000,0); --Bạc thường
		pPlayer.AddBindCoin(100000); --Đồng khóa

		pPlayer.Msg("<color=blue><color=yellow>Tiểu Linh<color> đã bị tiêu diệt, bạn nhận được phần thưởng hậu hĩnh từ Cố nhân Thiên Quỳnh Cung!<color>");
		
-----------------------------------------------
        GlobalExcute({"Dialog:GlobalNewsMsg_GS","<color=yellow><color=cyan>"..pPlayer.szName.."<color> đã đánh bại <color=yellow>Tiểu Linh<color> trong <color=red>Thiên Quỳnh Cung<color> nhận được phần thưởng cực hậu hĩnh!<color>"});
		KDialog.MsgToGlobal("<color=yellow><color=cyan>"..pPlayer.szName.."<color> đã đánh bại <color=yellow>Tiểu Linh<color> trong <color=red>Thiên Quỳnh Cung<color> nhận được phần thưởng cực hậu hĩnh!<color>");
