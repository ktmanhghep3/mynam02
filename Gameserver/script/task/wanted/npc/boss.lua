...
--me.AddStackItem(18,1,3941,2,nil,5);--Mảnh Cường Nhân (Chưa Giám Định)
	...
	if him.nLevel >= 90 then
		me.AddStackItem(18,1,3941,2,nil,3);--Mảnh Cường Nhân (Chưa Giám Định)
	elseif him.nLevel >= 80 then
		me.AddStackItem(18,1,3941,2,nil,2);--Mảnh Cường Nhân (Chưa Giám Định)
	elseif him.nLevel >= 70 then
		me.AddStackItem(18,1,3941,2,nil,1);--Mảnh Cường Nhân (Chưa Giám Định)
	end
