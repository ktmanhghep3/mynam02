...
function BaseRoom:TeamAward(tbTeam, nMinuteExp, nRepute, nPrestige, nOffer, bWinner)
	...
	local fnExcute = function (pPlayer)
		...
		pPlayer.AddBindCoin(10000);	--Đồng Khóa
		pPlayer.AddBindMoney(20000,0); --Bạc Khóa
		pPlayer.Earn(2000,0);	--Bạc
		pPlayer.AddStackItem(18,1,553,1,{bForceBind=1,},20);--Tiền Du Long
		pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},5);--Bí Ẩn Sát Thần
		pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},1);----Túi Thẻ Hoạt Động
		
		pPlayer.AddItem(18,1,4038,1); --Du Long Giác
		pPlayer.AddItem(18,1,4038,1); --Du Long Giác
		pPlayer.AddItem(18,1,4041,10); --Rương Tiêu Dao Đan Dược
		
		
		--pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},1);--Túi Quà: Lì Xì Thần Tài
