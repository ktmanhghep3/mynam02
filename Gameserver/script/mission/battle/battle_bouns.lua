...
function Battle:ProcessSeriesBouns(tbKillerBattleInfo, tbDeathBattleInfo)
	...
	if (5 >= (nPLRank - nMeRank)) then
		...
		if (math.fmod(nSeriesKill, 3) == 0) then	
			...
			if nCount >= 3 then
			tbKillerBattleInfo.pPlayer.Msg("<color=white>Nghi vấn post mạng, bạn không nhận được tích lũy liên trảm<color>");
			else
...
function Battle:AwardJbCoin(tbPlayerList)
	...
	for i = 1, #tbPlayerList do
		...
		local nJbBonus	= 0;
		if (1 == i) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},25);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP			
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},325);--Bí Ẩn Sát Thần
			tbBattleInfo.pPlayer.AddStackItem(18,1,3100,2,{bForceBind=1,},1);--Khoá Vô Cực
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},6);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},10);--Điểm Thành Tựu PK-Item
			tbBattleInfo.pPlayer.AddStackItem(18,1,3941,3,nil,10);--Mảnh Hiệp Khách (Chưa Giám Định)
			
			--tbBattleInfo.pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},5);--Túi Quà: Lì Xì Thần Tài
		--------------------------------------
		elseif (2 == i ) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},15);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP			
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},250);--Bí Ẩn Sát Thần
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},5);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},8);--Điểm Thành Tựu PK-Item
			tbBattleInfo.pPlayer.AddStackItem(18,1,3941,3,nil,7);--Mảnh Hiệp Khách (Chưa Giám Định)
			
			--tbBattleInfo.pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},4);--Túi Quà: Lì Xì Thần Tài
			--------------------------------------
		elseif (3 == i ) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},12);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP			
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},200);--Bí Ẩn Sát Thần
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},4);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},6);--Điểm Thành Tựu PK-Item
			tbBattleInfo.pPlayer.AddStackItem(18,1,3941,3,nil,5);--Mảnh Hiệp Khách (Chưa Giám Định)	

			--tbBattleInfo.pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},3);--Túi Quà: Lì Xì Thần Tài			
		--------------------------------------
		elseif (4 == i ) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},10);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP						
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},180);--Bí Ẩn Sát Thần	
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},3);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},4);--Điểm Thành Tựu PK-Item
			tbBattleInfo.pPlayer.AddStackItem(18,1,3941,3,nil,3);--Mảnh Hiệp Khách (Chưa Giám Định)
			
			--tbBattleInfo.pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},2);--Túi Quà: Lì Xì Thần Tài
		--------------------------------------
		elseif (5 == i ) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},5);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP			
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},160);--Bí Ẩn Sát Thần		
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},2);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},3);--Điểm Thành Tựu PK-Item
			
			--tbBattleInfo.pPlayer.AddStackItem(18,1,4018,1,{bForceBind=1,},1);--Túi Quà: Lì Xì Thần Tài
		--------------------------------------
		elseif (6 <= i and 20 >= i) then
			tbBattleInfo.pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},5);--Lệnh Bài Sát Thần PK
			tbBattleInfo.pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			tbBattleInfo.pPlayer.AddExp(1000000);					--EXP			
			tbBattleInfo.pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},160);--Bí Ẩn Sát Thần		
			tbBattleInfo.pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},1);--Túi Thẻ Hoạt Động
			tbBattleInfo.pPlayer.AddStackItem(18,1,3900,1,{bForceBind=1,},1);--Điểm Thành Tựu PK-Item
...
function Battle:AwardGood(pPlayer, nItemId, nPaiCount, nFuCount, nBouns, nBattleLevel)
	...
	for i = 1, Battle.nTimes do
		...
		if (nBouns >= 1000) and (nBouns < 1999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},4);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
			
		elseif (nBouns >= 2000) and (nBouns < 2999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},5);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
			
		elseif (nBouns >= 3000) and (nBouns < 3999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},6);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
			
		elseif (nBouns >= 4000) and (nBouns < 4999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},7);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
			
		elseif (nBouns >= 5000) and (nBouns < 5999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},8);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP

		elseif (nBouns >= 6000) and (nBouns < 6999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},9);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 7000) and (nBouns < 7999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},10);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},1);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 8000) and (nBouns < 8999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},11);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},2);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 9000) and (nBouns < 9999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},12);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},2);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 10000) and (nBouns < 10999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},13);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},2);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 11000) and (nBouns < 11999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},14);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},3);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 12000) and (nBouns < 12999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},15);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},3);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 13000) and (nBouns < 13999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},16);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},3);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 14000) and (nBouns < 14999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},17);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},4);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 15000) and (nBouns < 15999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},18);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},4);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 16000) and (nBouns < 16999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},19);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},4);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 17000) and (nBouns < 17999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},20);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},5);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 18000) and (nBouns < 18999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},21);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},5);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
		elseif (nBouns >= 19000) and (nBouns < 19999) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},22);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},5);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
				
				
		elseif (nBouns >= 20000) then
			--pPlayer.AddStackItem(18,1,3001,1,{bForceBind=1,},23);--Lệnh Bài Sát Thần PK
			--pPlayer.AddStackItem(18,1,3000,1,{bForceBind=1,},6);--Rương Tinh Thạch
			pPlayer.AddExp(1000000);--EXP
