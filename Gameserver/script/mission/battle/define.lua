...
Battle.TIME_PLAYER_STAY = 300;	-- 在后营最多可待120秒
...
Battle.LEVEL_LIMIT	= { 90, 1, 201 };		-- 进不同战场需要的等级   mac dinh { 1, 1, 151 };
...
Battle.BTPLNUM_HIGHBOUND	= 150;									-- 双方阵营限定参战最大人数
Battle.BTPLNUM_NUMDIF		= 6;									-- 双方平衡人数最大差
