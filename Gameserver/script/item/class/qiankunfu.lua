...
tbItem.TaskGroup_Time = 4000; --Tính thời gian online ngày
tbItem.TaskID_Time = 1;

tbItem.TaskGroupTT = 4030;--TaskGroup Code Tân Thủ, TaskID: 1-Code T7, 2-Code Lễ 2-9
tbItem.TaskIDTT = 1;
...
if nMapId == 2000  then
Dialog:SendBlackBoardMsg(me, string.format("<color=red>Không thể sử dụng Càn Khôn Phù tại đây!<color>"));
return;
end;
