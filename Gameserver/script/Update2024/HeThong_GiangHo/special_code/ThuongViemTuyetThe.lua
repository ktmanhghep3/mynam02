local tbGiangHo = Npc:GetClass("ThuongViemTuyetThe");

tbGiangHo.ID_skillGiangHo = 1719;
tbGiangHo.ManhGhep = {18,1,3942,2};	--Mảnh Cường Nhân
tbGiangHo.ManhGhepSuDung = 100;
tbGiangHo.MayManTienCap = 3;
tbGiangHo.GioiHanLevel = 20;
tbGiangHo.Name_ManhGhep = "Mảnh Cường Nhân";
tbGiangHo.Name_GiangHo = "Thương Viêm Tuyệt Thế";
...
function tbGiangHo:KichHoat_GiangHo()
	...
	local tbItemId_TruMG	= {18,1,3942,2,0,0};				--Mảnh Bí Bảo
	local nCountMG = me.GetItemCountInBags(18,1,3942,2) --Mảnh Bí Bảo
