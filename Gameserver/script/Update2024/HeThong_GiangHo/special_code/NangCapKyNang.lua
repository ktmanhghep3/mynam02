local tbGiangHo = Npc:GetClass("NangCapKyNangGiangHo1");

tbGiangHo.ID_skillGiangHo = 1718;
tbGiangHo.ManhGhep = {18,1,3942,1};	--Mảnh Bí Bảo
tbGiangHo.ManhGhepSuDung = 25;
tbGiangHo.MayManTienCap = 5;
tbGiangHo.GioiHanLevel = 20;
tbGiangHo.Name_ManhGhep = "Mảnh Bí Bảo";
tbGiangHo.Name_GiangHo = "Đạp Phong Bộ";

--Đạp Phong Bộ--
function tbGiangHo:DapPhongBo()
...
"<color=yellow>❂ Đẳng cấp: "..level_HienTai.."/"..self.GioiHanLevel.."<color>"..
"<color=yellow>❂ Tỷ lệ Thành công: "..self.MayManTienCap.." <color>"
local tbOpt = 
{
...
function tbGiangHo:KichHoat_GiangHo()
	...
	local tbItemId_TruMG	= {unpack(self.ManhGhep),0,0};				--Mảnh Bí Bảo
	local nCountMG = me.GetItemCountInBags(unpack(self.ManhGhep)) --Mảnh Bí Bảo
