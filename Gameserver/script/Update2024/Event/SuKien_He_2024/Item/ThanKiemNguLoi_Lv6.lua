local tbItem = Item:GetClass("ThanKiemNguLoi_Lv6");

tbItem.SKill_ThanKiemNguLoi_Lv5 = 1781;						--Skill ID
tbItem.Level_ThanKiemNguLoi = 6;							--Cấp Skill
tbItem.nThoiGian = 900;										--Thời gian học(s)
tbItem.GioiHanChungServer_HocSkillNguLoiChanQuyet = 5;		--GIỚI HẠN CẢ SERVER

tbItem.Item_Delete = {18,1,3911,4};							--ID Item
...
local Cap_ThanKiemNguLoi = me.GetSkillLevel(self.SKill_ThanKiemNguLoi_Lv5);
	...
	--if Cap_ThanKiemNguLoi >= self.Level_ThanKiemNguLoi then
		--Dialog:SendBlackBoardMsg(me, string.format("<color=yellow>Thần Kiếm Ngự Lôi Chân Quyết đã đạt: <color=cyan>+".. Cap_ThanKiemNguLoi .." <color>, không thể sử dụng nữa!<color>"));
		--return 0;
	--end
...
--local TenPhanThuong = "Thần Kiếm Ngự Lôi Chân Quyết +10";
