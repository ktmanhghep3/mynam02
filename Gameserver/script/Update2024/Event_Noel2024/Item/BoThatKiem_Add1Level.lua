local tbItem = Item:GetClass("BoThatKiem_Add1Level");

tbItem.ThatKiemNew = 1756;
tbItem.Item_Delete = {18,1,4014,1};				--ID Item
tbItem.Level_Add = 1;
tbItem.ThoiGian_delay = 1;	
tbItem.CapThatKiem = 45;

function tbItem:OnUse()
local szMsg = 
"<color=pink>Thông tin Bộ Thất Kiếm:\n"..
"<color=yellow>- Bộ Thất Kiếm: <color=cyan>+1<color>/"..self.CapThatKiem.."<color>\n"
...
GeneralProcess:StartProcess("<color=yellow>Đang lĩnh ngộ Thất Kiếm...", self.ThoiGian_delay * Env.GAME_FPS, {self.kichhoat, self}, nil, tbBreakEvent);
	else
		Dialog:Say("<bclr=0,0,200><color=white>Các loại Trang bị sau phải lấy ra khỏi người mới Lĩnh ngộ được Thất Kiếm: \n-Nón.\n-Áo.\n-Lưng.\n-Vũ khí.\n-Giày.\n-Tay.\n-Phù.\n-Nhẫn.\n-Liên.\n-Bội.\n-Ngựa.\n-Mặt Nạ.\n-Bí Kiếp.\n-Trận (Tuyệt Kỹ).\n-Ấn.\n-Phi Phong.\n-Quan Ấn.<color>")
		return 0;
	end
...
me.AddFightSkill(self.ThatKiemNew,nThatKiemNew + self.Level_Add);--ThatKiemNew 1

local szMsg = "<color=yellow>Người chơi: ["..me.szName.."] đã kích hoạt Thất Kiếm <color=green>(+".. (nThatKiemNew + self.Level_Add) ..")<color> thành công!<color>";
me.Msg("Kích hoạt Thất Kiếm <color=green>(+".. (nThatKiemNew + self.Level_Add) ..")<color> thành công!")
