local tbItem = Item:GetClass("ThanKiemNguLoi_Add1Level");
...
tbItem.Level_Add = 1;
tbItem.Item_Delete = {18,1,4011,1};						--ID Item
...
GeneralProcess:StartProcess("<color=yellow>Đang lĩnh ngộ Chân Quyết...", self.ThoiGian_delay * Env.GAME_FPS, {self.kichhoat, self}, nil, tbBreakEvent);
		...
		Dialog:Say("<bclr=0,0,200><color=white>Các loại Trang bị sau phải lấy ra khỏi người mới Lĩnh ngộ được Kỹ Năng Thần Kiếm Ngự Lôi Chân Quyết: \n-Nón.\n-Áo.\n-Lưng.\n-Vũ khí.\n-Giày.\n-Tay.\n-Phù.\n-Nhẫn.\n-Liên.\n-Bội.\n-Ngựa.\n-Mặt Nạ.\n-Bí Kiếp.\n-Trận (Tuyệt Kỹ).\n-Ấn.\n-Phi Phong.\n-Quan Ấn.<color>")
		return 0;
	end
