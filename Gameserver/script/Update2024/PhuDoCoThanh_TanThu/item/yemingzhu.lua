...
local tbYemingzhuItem = Item:GetClass("qinling_yemingzhu_2");

function tbYemingzhuItem:OnUse()
	
	local tbOpt = {
		{"Đúng", Boss.LongHonCoQuat.OnUseYemingzhu, Boss.LongHonCoQuat, me.nId},
		{"Không"},
	}
	
	local nNum = Boss.LongHonCoQuat:GetCostNum(me);
