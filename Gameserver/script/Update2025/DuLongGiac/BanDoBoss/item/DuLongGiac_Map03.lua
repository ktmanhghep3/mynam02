local tbItem = Item:GetClass("DuLongGiac_Map03");
tbItem.Item_Ruong = {18,1,4041,8};  --Bản đồ chưa giám định
...
function tbItem:OnUse()
	...
	--Phần thưởng 1
	local pItem = me.AddItem(18,1,4041,9);--Bản đồ Bạch Hổ Mật Chỉ
