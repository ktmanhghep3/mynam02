local tbItemStorage = Item:GetClass("Box_VPDuLong");

tbItemStorage.TASKID_GROUP = 4532;
...
tbItemStorage.DISPLAY_ITEM_LIST = 1;  -- 0 tắt, 1 bật
tbItemStorage.FILE_PATHS = {
    ITEM_DATA = "\\setting\\DuLong\\List_VatPhamDuLong.txt",
    LOG_BIG_GUI_VAT_PHAM = "\\setting\\DuLong\\Box_VPDuLong_LogGui.txt",
    LOG_BIG_RUT_VAT_PHAM = "\\setting\\DuLong\\Box_VPDuLong_LogRut.txt"
};
...
function tbItemStorage:OnUse()
    ...
    local szDialogMsg = "Vật phẩm thuộc Du Long Giác:";
