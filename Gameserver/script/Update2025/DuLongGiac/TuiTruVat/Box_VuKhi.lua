local tbItemStorage = Item:GetClass("Box_VuKhi");

tbItemStorage.TASKID_GROUP = 4533;
tbItemStorage.ITEM_DATA = {};  -- Dữ liệu vật phẩm
tbItemStorage.ITEM_CACHE = {}; -- Cache dữ liệu số lượng item
tbItemStorage.DATA_LOADED = false; -- Flag để kiểm tra dữ liệu đã được tải
tbItemStorage.DISPLAY_ITEM_LIST = 0;  -- 0 tắt, 1 bật
tbItemStorage.FILE_PATHS = {
    ITEM_DATA = "\\setting\\DuLong\\List_VuKhi.txt",
    LOG_BIG_GUI_VAT_PHAM = "\\setting\\DuLong\\Box_VuKhi_LogGui.txt",
    LOG_BIG_RUT_VAT_PHAM = "\\setting\\DuLong\\Box_VuKhi_LogRut.txt"
};
...
function tbItemStorage:OnUse()
    ...
    local szDialogMsg = "Vật phẩm thuộc Vũ khí Thanh Hạ-Thương Phong:";
