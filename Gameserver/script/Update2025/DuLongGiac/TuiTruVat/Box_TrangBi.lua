local tbItemStorage = Item:GetClass("Box_TrangBi");

tbItemStorage.TASKID_GROUP = 4534;
...
tbItemStorage.FILE_PATHS = {
    ITEM_DATA = "\\setting\\DuLong\\List_TrangBi.txt",
    LOG_BIG_GUI_VAT_PHAM = "\\setting\\DuLong\\Box_TrangBi_LogGui.txt",
    LOG_BIG_RUT_VAT_PHAM = "\\setting\\DuLong\\Box_TrangBi_LogRut.txt"
};
...
function tbItemStorage:OnUse()
    ...
    local szDialogMsg = "Vật phẩm thuộc Trang bị Vô Cực:";
