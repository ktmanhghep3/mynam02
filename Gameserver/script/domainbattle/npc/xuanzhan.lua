...
function tbNpc:OnDialog()
	...
	if Domain:GetBattleState() == Domain.PRE_BATTLE_STATE then
		tbOpt = Lib:MergeTable({{"<color=yellow>Tuyên chiến Tranh Đoạt Lãnh Thổ<color>", Domain.DeclareWar_Intro, Domain}}, tbOpt);
	end
    ...
    then
      tbOpt = Lib:MergeTable({{"<color=blue>Từ điển lãnh thổ tranh đoạt chiến<color>", self.AwardQuestion, self}}, tbOpt);
	end
