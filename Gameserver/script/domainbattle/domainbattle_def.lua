...
{-- 功勋档次&比例	帮会奖励价值量比例   档次名称					系统奖励价值量比例
 	{0.1,	   		0.18,			"Nhất Kỵ Đương Thiên (Xếp hạng trong bang trước 10%)",		0.19},
	{0.15,	   		0.21,			"Chiến Công Hiển Hách (Xếp hạng trong bang trước 25%)",		0.21},
	{0.20,	   		0.21,			"Hãn Mã Công Lao (Xếp hạng trong bang trước 45%)",		0.21},
	{0.25,	   		0.21,			"Phá Quân Hổ Vệ (Xếp hạng trong bang trước 70%)",		0.21},
	{0.3,        	0.19,			"Dũng Sĩ Sa Trường (Xếp hạng trong bang sau 70%)",		0.18},
}
...
-- 军需药PARTICULAR
JUNXU_MEDICINE_PARTICULAR = {273,274,275};
-- 军需行军丹PARTICULAR
...
JUNXU_NAME = {
				[JUNXU_MEDICINE] = {[1] = "Thuốc trung cấp",[2] = "Thuốc cao cấp"},
			  	[JUNXU_HELPFUL] = {[1] = "Hành Quân Đơn (tiểu)",[2] = "Hành Quân Đơn (trung)"},
			 };
			 
JUNXU_MEDICINE_NAME = {  
				[JUNXU_MEDICINE] = {[273] = "Hồi Huyết Đơn",
									[274] = "Hồi Nội Đơn", 
									[275] = "Càn Khôn Tạo Hóa Hoàn"}
			 };

-- NPC方帮会名称
NPC_TONG_NAME = 
{
	[0] = "Lưu Khấu không biết tên",
	[1] = "Tướng sĩ Tây Vực_lưu vong",
	[2] = "Tướng sĩ Kim Quốc_lưu vong",
	[3] = "Tướng sĩ Đại Lý Quốc_lưu vong",
	[4] = "Tướng sĩ Tống Quốc_lưu vong",
}
...
KILLER_LEVEL = 
{
	{0,		"<color=white>Binh sĩ<color>"},
	{2000,	"<color=green>Hiệu úy<color>"},
	{6000,	"<color=purple>Thống lĩnh<color>"},
	{8000,	"<color=gold>Phó tướng<color>"},
	{10000,	"<color=yellow>Đại Tướng<color>"},
};
