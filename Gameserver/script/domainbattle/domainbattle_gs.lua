...
function Domain:StartDomainBattle_GS2(nBattleNo, nDataVer)
	...
	local szMsg = "<color=cyan>Tranh Đoạt Lãnh Thổ<color> đã bắt đầu nhận Tuyên chiến, hãy đến Quan Lãnh Lhổ các thành để xác định mục tiêu chinh chiến, <color=cyan>thời gian còn 30 phút<color>!"
