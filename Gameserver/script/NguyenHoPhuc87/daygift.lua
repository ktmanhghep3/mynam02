...
local tbPhanThuong = Npc:GetClass("daygift");
...
local msg = "<color=red>Chú ý<color>: VIP nhận thưởng nhiều hơn ở lần 1 và lần 2. Hãy đem theo <color=cyan>[KTCT] Thẻ V.I.P<color> nếu ngươi có."
local tbOpt = {};
if (nCount3 >= 1) then
