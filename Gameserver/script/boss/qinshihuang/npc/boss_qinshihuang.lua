...
function tbQinshihuangBoss:OnDeath(pNpcKiller)
	...
	pPlayer.AddExp(10000000000) -- 100tr EXP
	pPlayer.AddStackItem(18,1,3006,1,{bForceBind=1,},200);--Bí Ẩn Sát Thần
	pPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},5);--Túi Thẻ Hoạt Động
	...
	if nTeamId == 0 then
		...
		for i, nPlayerId in pairs(tbPlayerId) do
			...
			if (pTeamPlayer and pTeamPlayer.nMapId == him.nMapId) then
				...
				pTeamPlayer.AddExp(10000000000) -- 100tr EXP
				pTeamPlayer.AddStackItem(18,1,3006,1,nil,25);--Bí Ẩn Sát Thần
				pTeamPlayer.AddStackItem(18,1,3101,1,{bForceBind=1,},2);--Túi Thẻ Hoạt Động				
			end
		end
	end
