	...
	[10] = --偷取类属性
	{
		{ "steallife_p",
			function(tbMagic1, tbSkillInfo, tbMagic2, bEx2)
				...
				szMsg = szMsg.."%<color> chuyển thành Sinh lực"..((tbMagic1[1] >= 0) and " Bổ sung" or " Tổn thất");
				return szMsg;
			end
		},
		{ "stealmana_p",
			function(tbMagic1, tbSkillInfo, tbMagic2, bEx2)
				...
				szMsg = szMsg.."Sát thương <color=gold>";
				szMsg = szMsg..((tbMagic1[1] >= 0) and Add4( tbMagic1[1],  tbMagic2 and tbMagic2[1], bEx2) or Add4(-tbMagic1[1],  tbMagic2 and -tbMagic2[1], bEx2));
				szMsg = szMsg.."%<color> chuyển thành Nội lực"..((tbMagic1[1] >= 0) and " Bổ sung" or " Tổn thất");
				return szMsg;
			end
		},
		{ "stealstamina_p",
			function(tbMagic1, tbSkillInfo, tbMagic2, bEx2)
				...
				szMsg = szMsg.." sát thương <color=gold>";
				szMsg = szMsg..((tbMagic1[1] >= 0) and Add4( tbMagic1[1],  tbMagic2 and tbMagic2[1], bEx2) or Add4(-tbMagic1[1],  tbMagic2 and -tbMagic2[1], bEx2));
				szMsg = szMsg.."%<color> chuyển thành Thể lực"..((tbMagic1[1] >= 0) and " Bổ sung" or " Tổn thất");
				return szMsg;
			end
		},
		{ "steallifeenhance_p",
