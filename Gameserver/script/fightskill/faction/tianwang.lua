...
local tb	= {
	...
	zhuixingzhuyue={ --追星逐月
		...
		physicsdamage_v={
			[1]={{1,400*0.9*FightSkill.tbParam.nS1},{10,400*0.9},{20,400*0.9*FightSkill.tbParam.nS20},{21,400*0.9*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}},
			[3]={{1,400*1.1*FightSkill.tbParam.nS1},{10,400*1.1},{20,400*1.1*FightSkill.tbParam.nS20},{21,400*1.1*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}}
			},
		seriesdamage_r={{{1,100},{20,250},{21,250}}},
	...
	qiangtianadvancedbook_child={ --枪天高级秘籍_10
		...
		superposemagic={{{1,9},{10,999},{11,999}}},
