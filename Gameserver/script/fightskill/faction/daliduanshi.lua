...
local tb	= {
	...
	lingboweibu={ --凌波微步_20
		fastwalkrun_p={{{1,40},{20,100},{21,110}}},--Tốc độ di chuyển
		ignoreskill={{{1,15},{2,16},{3,17},{4,18},{5,19},{6,20}},0,{{1,3},{2,3}}},--tránh công nội ngoại

		state_knock_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị tấn công đẩy lùi
		state_drag_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị kéo lại
		state_hurt_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị thương
		state_weak_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị suy yếu
		state_burn_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị bỏng
		state_stun_resistrate={{{1,100},{20,1000},{20,1050}}},--Xác suất bị choáng

		skill_cost_v={{{1,100},{10,150},{20,300},{21,300}}},--Nội lực mất
		
		skill_statetime={{{1,18*5},{20,18*6},{21,18*7}}},--Time Duy trì
		
		skill_mintimepercast_v={{{1,20*18},{20,45*18},{21,45*18}}},--Time dãn cách
		skill_mintimepercastonhorse_v={{{1,20*18},{20,45*18},{21,45*18}}},--Time dãn cách
	...
	zhiduan120={ --指段120_10
		...
		colddamage_v={
			...
			[3]={{1,650*1.1*FightSkill.tbParam.nS1},{10,650*1.1*FightSkill.tbParam.nS20},{11,650*1.1*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd1}}
			},
		seriesdamage_r={{{1,100},{10,250},{11,250}}},
		skill_cost_v={{{1,45},{10,90},{11,90}}},
		state_hurt_attack={{{1,7},{10,40}},{{1,18},{10,18}}},
		state_slowall_attack={{{1,7},{10,40}},{{1,18},{10,36},{11,36}}},
		missile_hitcount={{{1,5},{10,5}}},
		skill_appendskill2={{{1,1263},{1,1263}},{{1,1},{10,10},{11,10}}},
		skill_mintimepercast_v={{{1,55*18},{10,55*18}}},		--THOI GIAN GIAN CACH 120
		skill_mintimepercastonhorse_v={{{1,55*18},{10,55*18}}},
	},
	--[[
	...
	liumaishenjian={ --六脉神剑主_伤
		...
		seriesdamage_r={{{1,1000},{20,2500},{21,2500}}},
