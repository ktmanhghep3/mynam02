...
local tb	= {
	...
	aluohanshengong={ --阿罗汉神功_20
		meleedamagereturn_p={{{1,10},{10,35},{20,45},{30,75},{40,100},{45,112}}},
		rangedamagereturn_p={{{1,10},{10,35},{20,45},{30,75},{40,100},{45,112}}},
	},
	aluohanshengong_team={ --阿罗汉神功_队友
		meleedamagereturn_p={{{1,1},{10,5},{20,10},{22,13}}},
		rangedamagereturn_p={{{1,1},{10,5},{20,10},{22,13}}},
	},
	...
	daoshaoadvancedbook = { --刀少高级秘籍_10
		...
		steallifeenhance_p={{{1,-1},{10,-1}},{{1,100},{10,100}}},
	...
	gunshao120={ --棍少120_10
		...
		steallife_p={{{1,-100},{10,-100}},{{1,100},{20,100}}},
