...
local tb	= {
	...
	kunlundaofa={ --昆仑刀法_10
		...
		attackspeed_v={{{1,5},{10,15},{11,16},{12,40},{13,40}}},
	...
	wurenwuwo={ --无人无我_10
		...
		steallifeenhance_p={{{1,3},{2,6},{3,9}},{{1,100},{10,100}}},
	},
	wurenwuwo_team={ --无人无我
	...
	daoguxianfeng={ --道骨仙风_20
		damage_physics_resist={{{1,60},{2,81},{3,102}}},
		damage_cold_resist={{{1,60},{2,81},{3,102}}},
		damage_fire_resist={{{1,60},{2,81},{3,102}}},
		damage_light_resist={{{1,60},{2,81},{3,102}}},
