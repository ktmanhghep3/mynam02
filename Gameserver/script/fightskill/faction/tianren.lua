...
local tb	= {
	...
	moyanzaitian={ --魔炎在天
		...
		damage_physics_resist={{{1,68},{2,108},{3,148}}},
		damage_cold_resist={{{1,68},{2,108},{3,148}}},
		damage_fire_resist={{{1,68},{2,108},{3,148}}},
		damage_light_resist={{{1,68},{2,108},{3,148}}},
	...
	feihongwuji={ --飞鸿无迹_10
		appenddamage_p= {{{1,110*FightSkill.tbParam.nS1},{10,110},{11,110*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
		physicsenhance_p={{{1,9*FightSkill.tbParam.nS1},{10,90},{11,90*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}},
		firedamage_v={
			[1]={{1,100*0.9*0.7},{10,1500*0.9},{11,1500*0.9*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}},
			[3]={{1,100*1.1*0.7},{10,1500*1.1},{11,1500*1.1*FightSkill.tbParam.nS20*FightSkill.tbParam.nSadd}}
			},
	...
	shufuzhou={ --束缚咒_10
		...
		damage_physics_resist={{{1,44},{2,70},{3,96}}},
		damage_cold_resist={{{1,44},{2,70},{3,96}}},
		damage_fire_resist={{{1,44},{2,70},{3,96}}},
		damage_light_resist={{{1,44},{2,70},{3,96}}},
	...
	moren120={ --魔忍120_10
		...
		steallifeenhance_p={{{1,1},{2,2},{3,3}},{{1,100},{10,100}}},
