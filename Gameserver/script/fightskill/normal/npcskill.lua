...
---------------------------------------------------------------------
	npc_recdmgdec_reduce_p={ --减少受到的伤害,每级5%,5%到100%
		redeivedamage_dec_p = {{	
			{	1	,	6	},
			{	2	,	12	},
			{	3	,	18	},
	...
	npc_dmgmaxhp2= { --按最大比例减血，每级1%
		...
		state_stun_attack = {{{1,55},{10,100},{11,105}},{{1,18*3},{10,18*5.0},{11,18*5.5}}},
		state_freeze_attack = {{{1,55},{10,100},{11,105}},{{1,18*3},{10,18*5.0},{11,18*5.5}}},
		colddamage_v = {{{1,100},{2,50},{20,1050}},{{1,9*10},{20,9*10}}},
		lightingdamage_v = {{{1,100},{2,50},{20,1050}},{{1,9*10},{20,9*10}}},
	...
	npc_dmgmaxhp_knock= { --按最大比例减血，每级5%,并击退
	...
	npc_dmgmaxhp= { --按最大比例减血，每级5%
		reducepercentonmaxhp_p={{{1,100},{2,150}},{{1,0},{10,0}},{{1,0},{10,0}}},
		state_hurt_attack = {{{1,41},{10,51},{20,61}},{{1,2*18},{20,4*18}}},
	...
	npc_dmgmaxhp3 = { --按最大比例减血，每级5%
		reducepercentonmaxhp_p={{{1,100},{2,150}},{{1,0},{10,0}},{{1,0},{10,0}}},
		state_stun_attack={{{1,100},{2,150}},{{1,0},{10,0}},{{1,0},{10,0}}},
		state_burn_attack={{{1,100},{2,150}},{{1,0},{10,0}},{{1,0},{10,0}}},		
		poisondamage_v = {{{1,100},{2,50},{20,1050}},{{1,9*10},{20,9*10}}},
		lightingdamage_v = {{{1,100},{2,50},{20,1050}},{{1,9*10},{20,9*10}}},
		firedamage_v = {{{1,100},{2,50},{20,1050}},{{1,9*10},{20,9*10}}},
