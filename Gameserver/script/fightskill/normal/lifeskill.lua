--生活技能的buff
local tb	= {
	lifeskill_lifemax_p={ --H? Giáp Phi?n
	...
	lifeskill_damage_all_resist={ --Ng? Hành Th?ch
		damage_all_resist={{{1,10},{2,16},{3,23},{4,31},{5,40},{6,50},{7,61},{8,73},{9,86},{10,9999}}},
		skill_statetime={18}
	},
	
	lifeskill_modaoshi={ --Ma ?ao Th?ch
