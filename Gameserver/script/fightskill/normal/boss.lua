...
--秦始皇陵debuff
	...
	Boss2024_Khang ={
		...
		lifereplenish_p={{{1,99999},{2,99999}}},--Hi?u su?t h?i ph?c sinh l?c
		fastlifereplenish_v={{{1,900000},{2,900000}}},--M?i n?a giay h?i ph?c sinh l?c
		damage_all_resist={{{1,999999},{2,999999}}},--Kháng t?t c?		
		adddefense_p = {{{1,999999},{2,999999}}},	--Né tránh %
		
		--dynamicmagicshield_v={{{1,99999},{2,99999}},{{1,100},{10,100}}}, --Hóa gi?i sát th??ng-
		
		ignoreskill={{{1,90},{2,90}},0,{{1,3},{2,3}}}, --Xác su?t 10% tránh c?ng n?i, duy trì 30s (c?p 1)-c?n ch?nh l?i <100% quá cao

		--steallife_p={{{1,1000},{2,1500}}},--sát th??ng chuy?n hóa thành sinh l?c
		--posionweaken={{{1,99999},{10,99999}},{{1,10},{10,100}}}, --Hóa gi?i sát th??ng ??c
