...
function FactionBattle:GiveABoxPlayer(pPlayer)
	...
	if pPlayer.CountFreeBagCell() < 5 then	-- 背包空间不足
...
function FactionBattle:ExchangeExp(nPlayerId, bConfirm)
	...
	if bConfirm == 1 then
		if pPlayer.CountFreeBagCell() < nXiangZi + nXiangZiEx + nFreeCount + 5 then
			local szError = string.format("Hành Trang không đủ chỗ trống, cần <color=green>%s<color> ô trống.", nXiangZi + nXiangZiEx + nFreeCount + 5) 
			pPlayer.Msg(szError);
			return 0;
		end
		...
		----------------Phan Thuong top 
		if self.BOX_NUM[nElimat - 2][1] == 1 then
		local tbItemInfo = {bForceBind = 0};
		me.AddStackItem(18,1,3001,1,tbItemInfo,30);--Lệnh Bài Sát Thần PK
		me.AddStackItem(18,1,3000,1,tbItemInfo,5);--Rương Tinh Thạch
		me.AddStackItem(18,1,3006,1,{bForceBind=1,},800);--Bí Ẩn Sát Thần		
		me.AddStackItem(18,1,3100,2,{bForceBind=1,},5);--Khoá Vô Cực
		me.AddStackItem(18,1,3101,1,{bForceBind=1,},10);--Túi Thẻ Hoạt Động
		
		me.AddStackItem(18,1,3900,1,{bForceBind=1,},200);--Điểm Thành Tựu PK-Item		
		me.AddStackItem(18,1,3941,3,nil,50);--Mảnh Hiệp Khách (Chưa Giám Định)
		end

		if self.BOX_NUM[nElimat - 2][1] == 2 then
		local tbItemInfo = {bForceBind = 0};
		me.AddStackItem(18,1,3001,1,tbItemInfo,22);--Lệnh Bài Sát Thần PK
		me.AddStackItem(18,1,3000,1,tbItemInfo,4);--Rương Tinh Thạch		
		me.AddStackItem(18,1,3006,1,{bForceBind=1,},600);--Bí Ẩn Sát Thần		
		me.AddStackItem(18,1,3100,2,{bForceBind=1,},4);--Khoá Vô Cực
		me.AddStackItem(18,1,3101,1,{bForceBind=1,},8);--Túi Thẻ Hoạt Động
		
		me.AddStackItem(18,1,3900,1,{bForceBind=1,},150);--Điểm Thành Tựu PK-Item
		me.AddStackItem(18,1,3941,3,nil,40);--Mảnh Hiệp Khách (Chưa Giám Định)
		end

		if self.BOX_NUM[nElimat - 2][1] == 3 or self.BOX_NUM[nElimat - 2][1] == 4 then
		local tbItemInfo = {bForceBind = 0};
		me.AddStackItem(18,1,3001,1,tbItemInfo,15);--Lệnh Bài Sát Thần PK
		me.AddStackItem(18,1,3000,1,tbItemInfo,3);--Rương Tinh Thạch		
		...
		me.AddStackItem(18,1,3900,1,{bForceBind=1,},100);--Điểm Thành Tựu PK-Item
		me.AddStackItem(18,1,3941,3,nil,25);--Mảnh Hiệp Khách (Chưa Giám Định)
		end

		if self.BOX_NUM[nElimat - 2][1] == 5 or self.BOX_NUM[nElimat - 2][1] == 6 or self.BOX_NUM[nElimat - 2][1] == 7 or self.BOX_NUM[nElimat - 2][1] == 8 then
		local tbItemInfo = {bForceBind = 0};
		me.AddStackItem(18,1,3001,1,tbItemInfo,12);--Lệnh Bài Sát Thần PK
		me.AddStackItem(18,1,3000,1,tbItemInfo,2);--Rương Tinh Thạch		
		...
		me.AddStackItem(18,1,3900,1,{bForceBind=1,},50);--Điểm Thành Tựu PK-Item
		me.AddStackItem(18,1,3941,3,nil,15);--Mảnh Hiệp Khách (Chưa Giám Định)
		end

		if self.BOX_NUM[nElimat - 2][1] == 9 or self.BOX_NUM[nElimat - 2][1] == 10 or self.BOX_NUM[nElimat - 2][1] == 11 or self.BOX_NUM[nElimat - 2][1] == 12 or self.BOX_NUM[nElimat - 2][1] == 13 or self.BOX_NUM[nElimat - 2][1] == 14 or self.BOX_NUM[nElimat - 2][1] == 15 or self.BOX_NUM[nElimat - 2][1] == 16  then
		local tbItemInfo = {bForceBind = 0};
		me.AddStackItem(18,1,3001,1,tbItemInfo,12);--Lệnh Bài Sát Thần PK
		me.AddStackItem(18,1,3000,1,tbItemInfo,2);--Rương Tinh Thạch		
