local tbThienGia_2025 = Npc:GetClass("ThienGia_2025");


tbThienGia_2025.nSkill = 1748;				--Skill Thiên Gia

tbThienGia_2025.NhanCap_1 = 1;				--Cấp Skill nhận được 1
tbThienGia_2025.NhanCap_2 = 2;				--Cấp Skill nhận được 2
tbThienGia_2025.NhanCap_3 = 3;				--Cấp Skill nhận được 3
tbThienGia_2025.NhanCap_4 = 4;				--Cấp Skill nhận được 4
tbThienGia_2025.NhanCap_5 = 5;				--Cấp Skill nhận được 5
tbThienGia_2025.NhanCap_6 = 6;				--Cấp Skill nhận được 6
tbThienGia_2025.NhanCap_7 = 7;				--Cấp Skill nhận được 7
tbThienGia_2025.NhanCap_8 = 8;				--Cấp Skill nhận được 8
tbThienGia_2025.NhanCap_9 = 9;				--Cấp Skill nhận được 9
tbThienGia_2025.NhanCap_10 = 10;				--Cấp Skill nhận được 10
tbThienGia_2025.NhanCap_11 = 11;				--Cấp Skill nhận được 11
tbThienGia_2025.NhanCap_12 = 12;				--Cấp Skill nhận được 12
tbThienGia_2025.NhanCap_13 = 13;				--Cấp Skill nhận được 13
tbThienGia_2025.NhanCap_14 = 14;				--Cấp Skill nhận được 14
tbThienGia_2025.NhanCap_15 = 15;				--Cấp Skill nhận được 15
...
function tbThienGia_2025:OnDialog()
...
table.insert(tbOpt, 1, {"<color=yellow>Tiến Cấp Thiên Gia Kiếm Lv: <color=cyan>"..(nLevel+1).."<color><color>", self.LuaChon, self, nLevel+1});
	
	
Dialog:Say(szMsg, tbOpt);
end

function tbThienGia_2025:LuaChon(nValue)
local szMsg = "<color=gold>[Hệ Thống Thiên Gia]<color>";
local nLevel = me.GetSkillLevel(self.nSkill);	--Thiên Gia Kiếm
	...
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow>Thiên Gia Kiếm chưa đạt cấp <color=cyan>"..nThienGiaSkill.."<color> không thể Tiến Cấp <color=red>"..(nThienGiaSkill+1).."<color>!<color>"));
	return 0;
	end
...
function tbThienGia_2025:OnOpenGiftOk(nValue, tbItemObj)
	local tbItemList	= {};
...
--------------------	
	...
	local szMsg = "<color=yellow>Người chơi <color=cyan>"..me.szName.."<color> <color=green>Tiếp cấp Thành Công<color> <color=cyan>Thiên Gia Kiếm "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>";
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow><color=green>Tiếp cấp Thành Công<color> <color=cyan>Thiên Gia Kiếm "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>"));
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg)
	KDialog.MsgToGlobal(szMsg);	

	else
	--Phần thưởng:		
	local szMsg = "<color=yellow>Người chơi <color=cyan>"..me.szName.."<color> <color=gray>Tiếp cấp Thất Bại<color> <color=cyan>Thiên Gia Kiếm "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>";
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow><color=gray>Tiếp cấp Thất Bại<color> <color=cyan>Thiên Gia Kiếm "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>"));
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg)
	KDialog.MsgToGlobal(szMsg);	
	end;
	end;	
...
function tbThienGia_2025:ChechItem(pItem, tbItemList, tbCountList)
	if (not pItem) then
		return 0;
	end;
