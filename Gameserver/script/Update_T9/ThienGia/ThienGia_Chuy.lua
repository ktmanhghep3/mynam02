local tbThienGia_Kiem = Npc:GetClass("ThienGia_Chuy");


tbThienGia_Kiem.nSkill = 1443;				--Skill Thiên Gia
...
table.insert(tbOpt, 1, {"<color=yellow>Tiến Cấp Thiên Gia Chùy Lv: <color=cyan>"..(nLevel+1).."<color><color>", self.LuaChon, self, nLevel+1});
...
local szMsg = "<color=gold>[Hệ Thống Thiên Gia]<color>";
local nLevel = me.GetSkillLevel(self.nSkill);	--Thiên Gia Chùy
	...
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow>Thiên Gia Chùy chưa đạt cấp <color=cyan>"..nThienGiaSkill.."<color> không thể Tiến Cấp <color=red>"..(nThienGiaSkill+1).."<color>!<color>"));
	return 0;
	end
...
--------------------	
	...
	local szMsg = "<color=yellow>Người chơi <color=cyan>"..me.szName.."<color> <color=green>Tiếp cấp Thành Công<color> <color=cyan>Thiên Gia Chùy "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>";
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow><color=green>Tiếp cấp Thành Công<color> <color=cyan>Thiên Gia Chùy "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>"));
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg)
	KDialog.MsgToGlobal(szMsg);	

	else
	--Phần thưởng:		
	local szMsg = "<color=yellow>Người chơi <color=cyan>"..me.szName.."<color> <color=gray>Tiếp cấp Thất Bại<color> <color=cyan>Thiên Gia Chùy "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>";
	Dialog:SendBlackBoardMsg(me, string.format("<color=yellow><color=gray>Tiếp cấp Thất Bại<color> <color=cyan>Thiên Gia Chùy "..nThienGiaSkill.."<color> với tỷ lệ thành công: <color=red>["..nRate.."/100]<color> !!<color>"));
	KDialog.NewsMsg(0, Env.NEWSMSG_COUNT, szMsg)
	KDialog.MsgToGlobal(szMsg);	
	end;
	end;	
