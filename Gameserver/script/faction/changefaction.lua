...
Faction.SWITCH_FACTION_CD			= 1800;   -- thoi gian chuyen phai
Faction.SWITCH_FACTION_BUF_ID		= 897;
Faction.MAX_USED_FACTION			= 11;	-- so luong mon phau phu tu
...
function Faction:SwitchFaction(pPlayer, nFactionId)
	...
	if( pPlayer.nMapId ~= 255)then -- 洗髓岛
		pPlayer.AddSkillState(self.SWITCH_FACTION_BUF_ID, 1, 2, self.SWITCH_FACTION_CD * Env.GAME_FPS, 1, 1, 1); -- 真实时间，死亡不清
	end
