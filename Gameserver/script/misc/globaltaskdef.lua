...
DBTASD_SERVER_SETMAXLEVEL200 = 78 --记录开启150级时间(格式:GetTime); 
DBTASD_SERVER_SETMAXLEVEL150 = 201 -- TASK DÙNG CHUNG TOÀN SV (1)

DBTASD_EVENT_TASKCHUNGTOANSV1 = 202;
DBTASD_GIOIHANADDHOATRUKDM = 204;
DBTASD_ADDBOSS_THAIHUCOLONG = 205;
DBTASD_SKINBOSS_THAIHUCOLONG = 206;
DBTASD_TIME_GOI_THAIHUCOLONG = 207;
DBTASD_GIOIHAN_HOACULONG = 208;
DBTASD_GIOIHAN_THUYCULONG = 209;
DBTASD_GIOIHAN_THANKIEMNGULOICHANQUYET = 210;
DBTASD_GIOIHAN_BOXPHOBAN_1 = 211;
