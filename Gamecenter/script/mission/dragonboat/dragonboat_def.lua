...
DragonBoat.PRODUCT_SKILL = {
	...
	[1] = {
		...
		{1363, "履冰", "使目标迟缓5秒，定点攻击。",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1364, "暗礁", "使目标眩晕2秒，定点攻击。",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1365, "掀浪", "使目标定身3秒，定点攻击。",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1366, "漩涡", "使目标混乱2秒，定点攻击。",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
	},
	
	--防御性
	[2] = {
		--技能Id，名称，描述，改造龙舟等级,需要绑定银两
		{1372, "石肤", "受定身及减速效果几率减少40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1373, "龙心", "受混乱及减速效果几率减少40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1374, "海魂", "受眩晕及减速效果几率减少40%",{[1]=1,[2]=1,[3]=1,[4]=1}, 15000},
		{1375, "逆鳞", "受所有负面效果几率减少30%",{[4]=1}, 30000},
	},
};
...
DragonBoat.MIS_UI 	= 
{
	[1] = {"<color=green>比赛开始剩余时间：<color=white>%s<color>"};
	[2] = {"<color=green>比赛剩余时间：<color=white>%s<color>"};
};
