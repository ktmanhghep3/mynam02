...
{
	["玄晶"] = {4, 5, 6, 7, 8, 9},	-- huy?n tinh 6 s? t??ng ?ng 1-6 sao khi quay ???c
	["精活"] = {1000, 3000, 6000, 9000, 12000, 15000},	-- tinh ho?t
	["银两"] = {10000, 30000, 60000, 90000, 120000, 150000},	-- b?c
	["绑金"] = {500, 1500, 3000, 6000, 9000, 12000},	-- ??ng khóa
	["宝箱"] = {1},
	["贝壳"] = {1, 3, 10, 35, 120, 400},	-- s? v? sò nh?n ???c khi quay
};
