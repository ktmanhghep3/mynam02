...
tbTong.TIME_START 	= 20100428;
tbTong.TIME_END		= 201005017;
tbTong.ITEM_AWARD	= {18,1,919,1}; -- 胜利徽章
tbTong.ITEM_VOTE	= {18,1,930,1}; -- 投票道具
tbTong.MOENY_AWARD	= 2010;
tbTong.LEVEL_LIMIT	= 60;
tbTong.AWARD_LIMIT	= 100; --100次内获得绑银

tbTong.TSK_GROUP 	  = 2119;
tbTong.TSK_VOTE_COUNT = 9;
tbTong.IVER_OPEN	  = 0;