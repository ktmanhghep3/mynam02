...
LaborDay.nGTPMkPMin_Couplet 	= 20000;			--鉴定消耗精活
LaborDay.OpenTime 			= 20100428;		--活动开始时间
LaborDay.CloseTime 			= 20100511;		--活动结束时间
...
LaborDay.IVER_nTogether = 0;		--五一劳动节活动-共同合力
LaborDay.IVER_nHero_Famous = 0;	--五一劳动节活动-名扬英雄